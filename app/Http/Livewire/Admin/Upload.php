    ...
    public function uploadBasicInformation(){
        ...
        foreach ($csvRecords as $csvRecord) {
            ...
            BasicInformation::create([
               ...
               'tax_dec_number' => $csvRecord[18],
               'remarks' => $csvRecord[19],
               'status' => $csvRecord[20],
               'land_bank_amortization' => $csvRecord[21],
               'amount' => $csvRecord[22],
               'date_paid' => \Carbon\Carbon::parse($csvRecord[23])->format('Y-m-d'),
               'date_of_cert' => \Carbon\Carbon::parse($csvRecord[24])->format('Y-m-d'),
               'ndc_direct_payment_scheme' => $csvRecord[25],
               'ndc_remarks' => $csvRecord[26],
            //    'notes' => $csvRecord[27],
            ]);
        }
