...
class UploadVideoAttachment extends Component implements Forms\Contracts\HasForms
{
    ...
    {
        return view('livewire.forms.upload-video-attachment');
    }
}
