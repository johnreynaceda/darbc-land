...
class UploadTaxDecAttachment extends Component implements Forms\Contracts\HasForms
{
    ...
    {
        return view('livewire.forms.upload-tax-dec-attachment');
    }
}
